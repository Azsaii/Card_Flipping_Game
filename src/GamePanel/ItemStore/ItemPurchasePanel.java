...
import GameObject.ItemData;
import GamePanel.Score.DoubleScoreStrategy;
...
import static GamePanel.ItemStore.ItemStorePanel.ITEM_COUNT;
...
public class ItemPurchasePanel extends JPanel {
    ...
    private JPanel createItemPanel(int i) {
        ...
        ItemLabel imageLabel = new ItemLabel(itemDatas[i].getId());
